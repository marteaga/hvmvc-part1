...
namespace Microsoft.Health.ItemTypes.Old
{
    ...
    /// </summary>
    /// 
    public class LabTestResultGroupV1 : HealthRecordItemData
    {
        /// <summary>
        /// Initialize a new instance of the <see cref="LabTestResultGroupV1"/> 
        /// class with default values.
        /// </summary>
        /// 
        public LabTestResultGroupV1()
        {
        }
        ...
        /// </exception>
        /// 
        public LabTestResultGroupV1(CodableValue groupName)
        {
            GroupName = groupName;
        }

        /// <summary>
        /// Populates this <see cref="LabTestResultGroupV1"/> instance from the data in the XML. 
        /// </summary>
        /// 
       ...
       public override void ParseXml(XPathNavigator navigator)
       {
           ...
           _subGroups = new Collection<LabTestResultGroupV1>();
           foreach (XPathNavigator subGroupNav in subGroupsIterator)
           {
               LabTestResultGroupV1 _subGroup = new LabTestResultGroupV1();
           ...
           _results = new Collection<LabTestResultDetailsV1>();
           foreach (XPathNavigator resultNav in resultsIterator)
           {
               LabTestResultDetailsV1 result = new LabTestResultDetailsV1();
        ...
        /// </summary>
        /// 
        public Collection<LabTestResultGroupV1> SubGroups
        {
            get { return _subGroups; }
        }
        private Collection<LabTestResultGroupV1> _subGroups =
        ...
        /// </summary>
        /// 
        public Collection<LabTestResultDetailsV1> Results
        {
            get { return _results; }
        }
        private Collection<LabTestResultDetailsV1> _results=new Collection<LabTestResultDetailsV1>();
