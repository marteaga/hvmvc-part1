...
namespace Microsoft.Health.ItemTypes.Old
{
    ...
    /// </remarks>
    /// 
    public class LabTestResultValueV1 : HealthRecordItemData
    {
        /// <summary>
        ...
        /// </exception>
        /// 
        public LabTestResultValueV1(GeneralMeasurement measurement) 
        {
        ...
        public override void ParseXml(XPathNavigator navigator)
        {
            ...
            _ranges = new Collection<TestResultRangeV1>();
            foreach (XPathNavigator rangeNav in rangesIterator)
            {
                TestResultRangeV1 _range = new TestResultRangeV1();
        ...
        public override void WriteXml(string nodeName, XmlWriter writer)
        {
            ...
            {
                XmlWriterHelper.WriteOpt<TestResultRangeV1>(
                    writer,
                    "ranges",
                    _ranges[index]);
            }
        ...
        /// </summary>
        /// 
        public Collection<TestResultRangeV1> Ranges
        {
            get { return _ranges; }
        }
        private Collection<TestResultRangeV1> _ranges=new Collection<TestResultRangeV1>();
