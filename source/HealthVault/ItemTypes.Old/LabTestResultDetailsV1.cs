...
namespace Microsoft.Health.ItemTypes.Old
{
    ...
    /// </summary>
    /// 
    public class LabTestResultDetailsV1 : HealthRecordItemData
    {
        /// <summary>
        ...
        public override void ParseXml(XPathNavigator navigator)
        {
            ...
            // value
            _value = 
                XPathHelper.GetOptNavValue<LabTestResultValueV1>(navigator,"value");
        ...
        public override void WriteXml(string nodeName, XmlWriter writer)
        {
            ...
            // value
            XmlWriterHelper.WriteOpt<LabTestResultValueV1>( 
                writer,
                "value",
                _value);
        ...
        /// </remarks>
        /// 
        public LabTestResultValueV1 Value
        {
            get { return _value;}
            set { _value = value; }
        }
        private LabTestResultValueV1 _value;
        ...
        public override string ToString()
        {
            ...
            string space = ResourceRetriever.GetSpace("resources");
