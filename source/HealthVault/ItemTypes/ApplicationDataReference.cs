...
namespace Microsoft.Health.ItemTypes
{
    ...
    public class ApplicationDataReference : HealthRecordItem
    {
        ...
        protected override void ParseXml(IXPathNavigable typeSpecificXml)
        {
            ...
            _openQueryId = XPathHelper.GetOptNavValueAsGuid(itemNav, "open-query-id");
        ...
        public override void WriteXml(XmlWriter writer)
        {
            ...
            XmlWriterHelper.WriteOptGuid(writer, "open-query-id", _openQueryId);
        ...
        /// 
        /// <remarks>
        /// The open query is executed by using the <see cref="OpenQuery"/> class.
        /// 
        /// This property is used when HealthVault serves data to the application directly. 
        /// </remarks>
        /// 
        public Guid? OpenQueryId
        {
            get { return _openQueryId; }
            set { _openQueryId = value; }
        }
        private Guid? _openQueryId;
