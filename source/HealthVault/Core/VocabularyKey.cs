...
namespace Microsoft.Health
{
    ...
    public class VocabularyKey
    {
        ...
        /// <summary>
        /// Gets or sets the code value of the <see cref="VocabularyItem"/> that is supposed to 
        /// be the first result in set of <see cref="VocabularyItem"/>s returned as a result. 
        /// </summary>
        /// 
        /// <value>
        /// A string representing the code value of the <see cref="VocabularyItem"/>.
        /// </value>
        /// 
        /// <remarks>
        /// If the code value is unspecified, the <see cref="VocabularyItem"/>s in the 
        /// <see cref="Vocabulary"/> are returned starting from the first 
        /// <see cref="VocabularyItem"/> in alphabetically sorted order on code values.
        /// </remarks>
        /// 
