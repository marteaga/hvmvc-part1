...
namespace Microsoft.Health
{
    ...
    public class ApplicationInfo
    {
        ...
        internal static ApplicationInfo CreateFromInfoXml(XPathNavigator app)
        {
            ...
            if (app.SelectSingleNode("app-auth-required").ValueAsBoolean)
            {
                appInfo.SetApplicationOptions(ApplicationOptions.ApplicationAuthorizationRequired);
            }
        ...
        /// </remarks>
        public static string[] ExpectedApplicationAttributes =
            {"hipaa", "clinicaltrial"};
