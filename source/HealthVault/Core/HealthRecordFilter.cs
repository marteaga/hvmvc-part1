...
{
    /// <summary>
    /// Defines a filter for use with <see cref="Microsoft.Health.HealthRecordSearcher"/>
    /// searches.
    /// </summary>
    /// 
    /// <remarks>
    ...
    public class HealthRecordFilter
    {
        ...
        /// </exception>
        /// 
        public HealthRecordFilter(string name) : this()
        {
            Name = name;
        }
        ...
        /// </exception>
        /// 
        public HealthRecordFilter(int maxItemsReturned) : this()
        {
        ...
        /// </exception>
        /// 
        public HealthRecordFilter(string name, int maxItemsReturned) : this()
        {
            Name = name;
            MaxItemsReturned = maxItemsReturned;
        }
        ...
        /// </param>
        /// 
        public HealthRecordFilter(params Guid[] typeIds) : this()
        {
        ...
        internal static HealthRecordFilter CreateFromXml(XPathNavigator nav)
        {
            ...
            filter.CurrentVersionOnly 
                = groupNav.SelectSingleNode(
                    "current-version-only").ValueAsBoolean;
