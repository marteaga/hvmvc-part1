...
{        
    ...
    public static class ItemTypeManager
    {
        ...
        private static void RegisterExternalTypeHandlers()
        {
            ...
            try
            {
                Assembly itemTypeAssembly =
                    GetAssemblyFromAppDomain("Microsoft.Health.ItemTypes");
            ...
            {
                Assembly itemTypeAssembly =
                    GetAssemblyFromAppDomain("Microsoft.Health.ItemTypes.Old");
        ...
        {
            StringReader stringReader = new StringReader(itemXml);             
            XmlReader thingReader =
                XmlReader.Create(
                    stringReader,
