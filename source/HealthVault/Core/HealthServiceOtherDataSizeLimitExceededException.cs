...
namespace Microsoft.Health
{
    ...
    /// 
    [Serializable]
    public sealed class HealthServiceOtherDataSizeLimitExceededException : HealthServiceException
    {
        /// <summary>
        ...
        /// </summary>
        /// 
        public HealthServiceOtherDataSizeLimitExceededException()
            : base()
        {
        }
        ...
        /// </param>
        /// 
        public HealthServiceOtherDataSizeLimitExceededException(string message)
            : base(message)
        {
        }
        ...
        /// </param>
        /// 
        public HealthServiceOtherDataSizeLimitExceededException(string message, Exception innerException)
        ...
        /// </param>
        /// 
        private HealthServiceOtherDataSizeLimitExceededException(
