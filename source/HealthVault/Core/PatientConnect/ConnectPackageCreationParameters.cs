...
namespace Microsoft.Health.Package
{
    ...
    public class ConnectPackageCreationParameters : IDisposable
    {
        ...
        internal List<Uri> PackageBlobReferenceUrls
        {
            get { return _packageBlobReferenceUrls; }
        }
        private List<Uri> _packageBlobReferenceUrls = new List<Uri>();
