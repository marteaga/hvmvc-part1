...
namespace Microsoft.Health
{
    ...
    public class HealthRecordItem
    {
        ...
        public void Sign (X509Certificate2 signingCertificate)
        {
            ...
            thingDoc.LoadXml(GetItemXml(_sections | HealthRecordItemSections.Signature));
        ...
        public bool IsSignatureValid()
        {
            ...
            thingDoc.LoadXml(signedThingXml);
        ...
        public DateTime EffectiveDate
        {
            ...
            internal set { _effectiveDate = value; }
        }
        ...
        {
            get { return (_flags & HealthRecordItemFlags.Personal) != 0; }
            set
            {
                if (value)
                {
        ...
        {
            get { return (_flags & HealthRecordItemFlags.DownVersioned) != 0; }
        }
        ...
        {
            get { return (_flags & HealthRecordItemFlags.UpVersioned) != 0; }
        }
        ...
        public string Serialize()
        {
            ...
            else
            {
                ...
                fetchedDocument.LoadXml(_fetchedXml);

                XmlDocument newDocument = new XmlDocument();
                newDocument.LoadXml(GetItemXml());
            ...
            HealthRecordItemSections sections)
        {
            ...
            if ((sections & HealthRecordItemSections.Core) != 0 && writeAllCore)
            {
                ...
                if (EffectiveDate != SDKHelper.DateUnspecified)
                {
                    // <eff-date>
            ...
            foreach (XPathNavigator dataXml in dataXmlIterator)
            {
                ...
                if (String.IsNullOrEmpty(transformName))
                {
                    ...
                    using (XmlReader reader =
                        XmlReader.Create(new StringReader(dataXml.OuterXml), settings))
                    {
                ...
                else
                {
                    ...
                    newDoc.LoadXml(dataXml.OuterXml);
