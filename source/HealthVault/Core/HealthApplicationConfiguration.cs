...
namespace Microsoft.Health
{
    ...
    public class HealthApplicationConfiguration
    {
        ...
        /// <summary>
        /// Gets the HealthVault client service URL from the application 
        ...
        /// </remarks>
        /// 
        public virtual Uri HealthVaultOpenQueryRequestUrl
        {
            get
            {
                if (HealthVaultUrl != null)
                {
                    return UrlPathAppend(HealthVaultUrl, "openquery.ashx");
                }
